...
public class DocumentMetadata implements Serializable {
    ...
    public static final String PROP_REGISTRATIONNUMBER = "regristrationnumber";
    ...
    public DocumentMetadata(String fileName, Date documentDate, String registrationnumber) {
        this(UUID.randomUUID().toString(), fileName, documentDate,registrationnumber);
    }
    
    public DocumentMetadata(String uuid, String fileName, Date documentDate, String registrationnumber) {
        super();
        this.uuid = uuid;
    ...
    public DocumentMetadata(Properties properties) {
        this(properties.getProperty(PROP_UUID),
             ...
             null,
             properties.getProperty(PROP_REGISTRATIONNUMBER));
    ...
    public void setPersonName(String registrationNumber) {
        this.registrationNumber = registrationNumber;
    }
    ...
    public Properties createProperties() {
        ...
        props.setProperty(PROP_REGISTRATIONNUMBER, getRegistrationNumber());
