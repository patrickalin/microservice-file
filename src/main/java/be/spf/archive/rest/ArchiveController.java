 ...
 * 
 * /archive/upload?file={file}&registrationnumber={person}&date={date}  Add a document  POST
 *   file: A file posted in a multipart request
 *   registrationNumber: The name of the uploading employer
 *   date: The date of the document
 *   
 * /archive/documents?registrationnumber={person}&date={date}           Find documents  GET
...
public class ArchiveController {
    ...
    public @ResponseBody DocumentMetadata handleFileUpload(
        ...
        try {
            Document document = new Document(file.getBytes(), file.getOriginalFilename(), date, registrationNumber );
